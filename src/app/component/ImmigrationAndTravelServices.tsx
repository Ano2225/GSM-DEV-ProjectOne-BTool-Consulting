    ...
    <section id="immigration-services" className="py-16 bg-gray-100">
      <div className="sm:max-w-screen-lg  container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <Link href="/services/immigration" className="text-secondary-turquoise font-bold hover:underline cursor-pointer">
              En savoir plus
            </Link>
          </div>
          <div className="bg-white p-6 shadow-lg rounded-lg text-center">
            ...
            <Link href="https://wa.me/+14025105742" 
 className="text-secondary-turquoise font-bold hover:underline cursor-pointer">
